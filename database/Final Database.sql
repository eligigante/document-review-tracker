...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 08, 2023 at 12:39 PM
...
ALTER TABLE `departments`
  ADD CONSTRAINT `user_ID_dept` FOREIGN KEY (`user_ID`) REFERENCES `user` (`user_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `department_ID_user` FOREIGN KEY (`department_ID`) REFERENCES `departments` (`department_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
